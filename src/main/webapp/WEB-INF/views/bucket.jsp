            ...
            <table class="table is-striped is-fullwidth">
                ...
                <c:forEach var="item" items="${items}">
                    <tr>
                        ...
                        <td><a class="button is-fullwidth is-small is-success is-rounded"
                               href="${pageContext.request.contextPath}/servlet/DeleteBucketItem?bucket_id=${bucket.id}&item_id=${item.id}">delete</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
            <a class="button is-success" href="${pageContext.request.contextPath}/servlet/completeOrder">COMPLETE
                ORDER</a><br>
        </div>
    </div>
</section>
